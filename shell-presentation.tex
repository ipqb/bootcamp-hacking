...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
\definecolor{ucsfteal}{RGB}{136,187,187}
\definecolor{ucsfgray}{RGB}{187,187,170}
\definecolor{ucsfdarkblue}{RGB}{0,51,102}
...
\author[Kyle] % (optional, use only with lots of authors)
{K-y/a-le}
